...
func TestSuppressionSetup(t *testing.T) {
	...
	// t.Setenv("Regulations.useBackupService", "true")
...
func httpHandler(t *testing.T) http.Handler {
	...
	srvMux.HandleFunc("/full-export", func(w http.ResponseWriter, r *http.Request) {
		http.ServeFile(w, r, "internal/badgerdb/testdata/full-export")
	}).Methods(http.MethodGet)
	srvMux.HandleFunc("/latest-export", func(w http.ResponseWriter, r *http.Request) {
		http.ServeFile(w, r, "internal/badgerdb/testdata/latest-export")
	}).Methods(http.MethodGet)
