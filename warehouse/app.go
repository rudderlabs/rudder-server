...
func New(
	...
	a.config.host = conf.GetStringVar("localhost", "WAREHOUSE_JOBS_DB_HOST")
	a.config.user = conf.GetStringVar("ubuntu", "WAREHOUSE_JOBS_DB_USER")
	a.config.password = conf.GetStringVar("ubuntu", "WAREHOUSE_JOBS_DB_PASSWORD")
	a.config.database = conf.GetStringVar("ubuntu", "WAREHOUSE_JOBS_DB_DB_NAME")
	a.config.sslMode = conf.GetStringVar("disable", "WAREHOUSE_JOBS_DB_SSL_MODE")
	a.config.port = conf.GetIntVar(5432, 1, "WAREHOUSE_JOBS_DB_PORT")
	a.config.mode = conf.GetStringVar("embedded", "Warehouse.mode")
	...
	a.config.maxOpenConnections = conf.GetIntVar(20, 1, "Warehouse.maxOpenConnections")
	a.config.configBackendURL = conf.GetStringVar("https://api.rudderstack.com", "CONFIG_BACKEND_URL")
	a.config.region = conf.GetStringVar("", "region")
