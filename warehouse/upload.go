...
func (job *UploadJob) fetchPendingUploadTableStatus() []*TableUploadStatusT {
...
// SetUploadSchema
func (job *UploadJob) setUploadSchema(consolidatedSchema warehouseutils.SchemaT) error {
...
func (job *UploadJob) setMergedSchema(mergedSchema warehouseutils.SchemaT) error {
...
func (job *UploadJob) GetLoadFilesMetadata(options warehouseutils.GetLoadFilesOptionsT) (loadFiles []warehouseutils.LoadFileT) {
...
func (job *UploadJob) GetSchemaInWarehouse() (schema warehouseutils.SchemaT) {
...
func (job *UploadJob) GetTableSchemaInWarehouse(tableName string) warehouseutils.TableSchemaT {
	return job.schemaHandle.schemaInWarehouse[tableName]
}

func (job *UploadJob) GetTableSchemaInUpload(tableName string) warehouseutils.TableSchemaT {
	return job.schemaHandle.uploadSchema[tableName]
}

func (job *UploadJob) GetSingleLoadFile(tableName string) (warehouseutils.LoadFileT, error) {
	sqlStatement := fmt.Sprintf(`
		SELECT
		  location
		FROM
...
func (job *UploadJob) GetLocalSchema() warehouseutils.SchemaT {
	return job.schemaHandle.getLocalSchema()
}

func (job *UploadJob) UpdateLocalSchema(schema warehouseutils.SchemaT) error {
