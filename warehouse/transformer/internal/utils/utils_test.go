...
func TestValidTimestamp(t *testing.T) {
	testCases := []struct {
		...
		{name: "Timestamps out of bounds (Before minTimeInMs)", timestamp: "0001-01-01T00:00:00.000Z", expected: false},
		{name: "Timestamps out of bounds (After maxTimeInMs)", timestamp: "9999-12-31T23:59:59.999Z", expected: false},
