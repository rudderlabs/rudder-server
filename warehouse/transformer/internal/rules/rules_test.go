...
func TestExtractRecordID(t *testing.T) {
	testCases := []struct {
		...
		{name: "recordId is nil", metadata: ptrans.Metadata{RecordID: nil}, expectedRecordID: nil, expectedError: errRecordIDEmpty},
		{name: "recordId is empty", metadata: ptrans.Metadata{RecordID: ""}, expectedRecordID: nil, expectedError: errRecordIDEmpty},
		{name: "recordId is not empty", metadata: ptrans.Metadata{RecordID: "123"}, expectedRecordID: "123", expectedError: nil},
		{name: "recordId is an object", metadata: ptrans.Metadata{RecordID: map[string]any{"key": "value"}}, expectedRecordID: nil, expectedError: errRecordIDObject},
...
func TestExtractCloudRecordID(t *testing.T) {
	testCases := []struct {
		...
		{name: "recordId is nil", message: types.SingularEventT{"context": map[string]any{"sources": map[string]any{"version": "1.0"}}}, metadata: ptrans.Metadata{}, fallbackValue: "fallback", expectedRecordID: nil, expectedError: errRecordIDEmpty},
		{name: "recordId is empty", message: types.SingularEventT{"context": map[string]any{"sources": map[string]any{"version": "1.0"}}}, metadata: ptrans.Metadata{RecordID: ""}, fallbackValue: "fallback", expectedRecordID: nil, expectedError: errRecordIDEmpty},
		{name: "recordId is an object", message: types.SingularEventT{"context": map[string]any{"sources": map[string]any{"version": "1.0"}}}, metadata: ptrans.Metadata{RecordID: map[string]any{"key": "value"}}, fallbackValue: "fallback", expectedRecordID: nil, expectedError: errRecordIDObject},
...
func TestFunctionalRules(t *testing.T) {
	t.Run("default", func(t *testing.T) {
		testCases := []struct {
			...
			{name: "extract (empty)", functionalRule: ExtractFunctionalRules["id"], event: ptrans.TransformerEvent{Metadata: ptrans.Metadata{RecordID: ""}}, expected: nil, expectedError: errRecordIDEmpty},
