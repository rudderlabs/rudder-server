...
VALUES (1, 'test-sourceID', 'test-namespace',
        ...
        1, 1, 1, 1, 'waiting', '{}', '{}', '{}',
        now(), now(), now(), now(),
        '[{ "exporting_data": "2020-04-21T15:16:19.687716Z", "exported_data": "2020-04-21T15:26:34.344356Z"}]'),
...
VALUES (1, 1,
       ...
       (5, 5,
        ...
        'POSTGRES', 'test-table', 1, NOW(),
        '{}');
INSERT INTO wh_table_uploads (id, wh_upload_id, table_name, status,
                              total_events, error, created_at,
                              updated_at)
VALUES (1, 1, 'test-table', 'waiting', 1, '',
        NOW(), NOW()),
