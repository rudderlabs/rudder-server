...
func (wh *HandleT) CrashRecover(_ warehouseutils.WarehouseT) (err error) {
	return nil
}
...
func (wh *HandleT) DropTable(_ string) (err error) {
...
func (wh *HandleT) IsEmpty(_ warehouseutils.WarehouseT) (bool, error) {
	return false, nil
}

func (wh *HandleT) TestConnection(_ warehouseutils.WarehouseT) error {
	return fmt.Errorf("datalake err :not implemented")
}
...
func (wh *HandleT) GetTotalCountInTable(_ string) (int64, error) {
	return 0, nil
}

func (wh *HandleT) Connect(_ warehouseutils.WarehouseT) (client.Client, error) {
	return client.Client{}, fmt.Errorf("datalake err :not implemented")
}

func (wh *HandleT) LoadTestTable(_, _ string, _ map[string]interface{}, _ string) error {
	return fmt.Errorf("datalake err :not implemented")
}

func (wh *HandleT) SetConnectionTimeout(_ time.Duration) {
}
