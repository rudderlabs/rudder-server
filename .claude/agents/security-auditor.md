...
Security for this project is paramount because we do not have control over the code that runs as "transformation code",
so part of your job is to ensure that whatever code is executed as "transformation code" cannot:
* Be misused
* Be exploited
* Escape the container
* Access unauthorized variables
* Access unauthorized libraries
