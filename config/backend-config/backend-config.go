...
func loadConfig() {
	...
	config.RegisterDurationConfigVariable(time.Duration(1500), &pollInterval, true, time.Second, []string{"BackendConfig.pollInterval", "BackendConfig.pollIntervalInS"}...)
