...
func (workspaceConfig *MultiTenantWorkspaceConfig) getWorkspaceRegulationsFromAPI() ([]WorkspaceRegulationT, bool) {
	start := 0
...
func (workspaceConfig *MultiTenantWorkspaceConfig) getSourceRegulationsFromAPI() ([]SourceRegulationT, bool) {
	start := 0
