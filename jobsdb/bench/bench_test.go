...
func TestBench(t *testing.T) {
	t.Run("simple", func(t *testing.T) {
		...
		c.Set("JobsDB.payloadColumnType", string(jobsdb.BYTEA))
		c.Set("JobsDB.enableToastOptimizations", false)
		c.Set("JobsDB.Compression.enabled", true)
		c.Set("JobsDB.Compression.algorithm", "gzip")
		c.Set("JobsDB.Compression.level", "fastest")
		...
		c.Set("JobsDB.Bench.insertRateLimit", 30000)
		c.Set("JobsDB.Bench.updateRateLimit", 30000)
		c.Set("JobsDB.Bench.getRateLimit", 30000)
	...
	t.Run("two_stage", func(t *testing.T) {
		...
		c.Set("JobsDB.Bench.readerReadSize", 20000)
		c.Set("JobsDB.Bench.payloadLimit", 100*bytesize.MB)
		c.Set("JobsDB.Bench.insertRateLimit", 60000)
		c.Set("JobsDB.Bench.updateRateLimit", 0)
		c.Set("JobsDB.Bench.getRateLimit", 0)
