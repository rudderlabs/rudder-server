...
func TestJobsDBStatusCache(t *testing.T) {
	...
	require.False(t, func() bool {return cache.HaveEmptyResult(ds1, wId1, []string{Waiting.State}, []string{customVal}, []ParameterFilterT{})}())

	cache.UpdateCache(ds1, wId1, []string{Waiting.State}, []string{customVal}, []ParameterFilterT{},
	cacheValue(noJobs), nil)
	require.True(t, func() bool {return cache.HaveEmptyResult(ds1, wId1, []string{Waiting.State}, []string{customVal},
		[]ParameterFilterT{})}())
	cache.UpdateCache(ds1, wId1, []string{Waiting.State}, []string{customVal}, []ParameterFilterT{},
		cacheValue(hasJobs), nil)
	require.False(t, func() bool {return cache.HaveEmptyResult(ds1, wId1, []string{Waiting.State}, []string{customVal},
		[]ParameterFilterT{})}())
}
