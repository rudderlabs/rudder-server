...
func (gw *Handle) Setup(
	...
	// Store suppressed user events as stripped dummy jobs instead of dropping them at the
	// gateway, so they can be reported and dropped downstream at the processor. false by default.
