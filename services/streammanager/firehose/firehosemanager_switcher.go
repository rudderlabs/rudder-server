...
func NewProducer(destination *backendconfig.DestinationT, o common.Opts) (FireHoseManager, error) {
	v2Enabled := config.GetReloadableBoolVar(false, "Router.FIREHOSE.useAWSV2", "Router.useAWSV2")
	...
	return &SwitchingFireHoseManager{isV2Enabled: v2Enabled, producerV1: producerV1, producerV2: producerV2}, nil
}
