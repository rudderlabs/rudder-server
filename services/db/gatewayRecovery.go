...
// HandleGatewayRecovery decides the recovery Mode in which app should run based on earlier crashes
func HandleGatewayRecovery(forceNormal bool, forceDegraded bool, forceMigrationMode string, currTime int64) {
