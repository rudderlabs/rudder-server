...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 9, 23, 6, 3, 21, 620213998, time.UTC),
		},
		...
		"/node/000005_alter_event_schemas_autovacuum.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 23, 6, 3, 21, 619965928, time.UTC),
		...
		"/node/000006_add_archived_to_event_schemas_tables.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 23, 6, 3, 21, 620104202, time.UTC),
		...
		"/node/000006_remove_archived_from_event_schemas_tables.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 23, 6, 3, 21, 620297641, time.UTC),
		...
		"/reports": &vfsgen۰DirInfo{
			name:    "reports",
			modTime: time.Date(2021, 9, 22, 11, 41, 36, 0, time.UTC),
		},
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2021, 9, 29, 12, 14, 59, 784060984, time.UTC),
		},
		...
		"/warehouse/000013_add_in_progress_to_wh_uploads.up.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 9, 29, 11, 13, 19, 787545825, time.UTC),
