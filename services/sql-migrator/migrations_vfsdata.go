...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 7, 6, 7, 2, 24, 555189095, time.UTC),
		},
		...
		"/node/000004_create_ops.down.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 6, 14, 7, 12, 47, 750489621, time.UTC),
		...
		"/node/000004_create_ops.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 6, 14, 7, 12, 47, 751074360, time.UTC),
		...
		"/node/00005_alter_event_schemas_autovacuum.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 7, 6, 7, 2, 57, 767371493, time.UTC),
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2021, 5, 11, 11, 57, 28, 183874051, time.UTC),
		},
