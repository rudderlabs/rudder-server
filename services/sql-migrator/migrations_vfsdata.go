...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 11, 4, 17, 9, 37, 394913213, time.UTC),
		},
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2020, 12, 3, 5, 29, 56, 300990707, time.UTC),
		},
		...
		"/jobsdb/000003_create_read_write_journal.down.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "000003_create_read_write_journal.down.tmpl",
			modTime:          time.Date(2020, 12, 3, 5, 30, 59, 492533410, time.UTC),
			uncompressedSize: 121,

			compressedContent: []byte(""),
		},
		"/jobsdb/000003_create_read_write_journal.up.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "000003_create_read_write_journal.up.tmpl",
			modTime:          time.Date(2020, 12, 3, 5, 24, 30, 384526075, time.UTC),
			uncompressedSize: 530,

			compressedContent: []byte(""),
		},
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2020, 12, 3, 6, 15, 8, 775869163, time.UTC),
		},
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2020, 11, 27, 13, 21, 26, 862977392, time.UTC),
		},
		...
		"/warehouse/000002_alter_wh_table_uploads.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 27, 13, 21, 26, 863182137, time.UTC),
	...
	fs["/jobsdb"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/jobsdb/000003_create_read_write_journal.down.tmpl"].(os.FileInfo),
		fs["/jobsdb/000003_create_read_write_journal.up.tmpl"].(os.FileInfo),
	}
