...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2020, 12, 23, 0, 32, 4, 173541747, time.UTC),
		},
		...
		"/jobsdb/000003_alter_journal_table.down.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 12, 23, 0, 32, 4, 173450842, time.UTC),
		...
		"/jobsdb/000003_alter_journal_table.up.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 12, 23, 0, 32, 4, 173923118, time.UTC),
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2020, 12, 24, 7, 7, 37, 726490898, time.UTC),
		},
