...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2021, 12, 30, 19, 0, 33, 31953077, time.UTC),
		},
		...
		"/jobsdb/000006_alter_dataset_table.down.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2022, 1, 3, 6, 8, 11, 21769226, time.UTC),
		...
		"/jobsdb/000006_alter_dataset_table.up.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2022, 1, 3, 6, 8, 18, 989528578, time.UTC),
