...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 7, 28, 7, 9, 51, 327586825, time.UTC),
		},
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2020, 7, 28, 5, 34, 59, 189751207, time.UTC),
		},
		"/jobsdb/000001_create_tables.down.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "000001_create_tables.down.tmpl",
			modTime:          time.Date(2020, 7, 8, 12, 55, 19, 516609509, time.UTC),
		...
		"/jobsdb/000001_create_tables.up.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 8, 12, 55, 19, 516773543, time.UTC),
		...
		"/jobsdb/000002_alter_dataset_tables.down.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 8, 12, 55, 19, 516881306, time.UTC),
		...
		"/jobsdb/000002_alter_dataset_tables.up.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 8, 12, 55, 19, 516988607, time.UTC),
