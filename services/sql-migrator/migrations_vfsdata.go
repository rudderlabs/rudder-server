...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2020, 12, 29, 6, 29, 39, 553355753, time.UTC),
		},
		...
		"/warehouse/000003_add_upd_col_to_wh_schemas_and_uniq_constraint.sql.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 29, 6, 29, 39, 553289405, time.UTC),
		...
		"/warehouse/000004_create_table_schema_versions.sql.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 29, 6, 27, 45, 113258969, time.UTC),
