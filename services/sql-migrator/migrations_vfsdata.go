...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2021, 8, 4, 8, 11, 33, 450715309, time.UTC),
		},
		...
		"/jobsdb/000004_alter_status_table.down.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 8, 4, 8, 11, 42, 537367962, time.UTC),
		...
		"/jobsdb/000004_alter_status_table.up.tmpl ": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 8, 4, 8, 11, 9, 437680248, time.UTC),
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 8, 4, 8, 1, 10, 374354666, time.UTC),
		},
		...
		"/node/00005_alter_event_schemas_autovacuum.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 8, 4, 8, 1, 10, 375201821, time.UTC),
