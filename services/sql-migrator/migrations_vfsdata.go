...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 5, 17, 18, 3, 37, 997179413, time.UTC),
		},
		...
		"/node/000004_create_ops.down.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 5, 17, 18, 3, 37, 997071705, time.UTC),
		...
		"/node/000004_create_ops.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 5, 18, 4, 34, 50, 661716320, time.UTC),
