...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 7, 28, 5, 53, 0, 779002672, time.UTC),
		},
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2020, 7, 28, 5, 37, 7, 708310763, time.UTC),
		},
		"/node/000001_create_event_schema.down.sql": &vfsgen۰CompressedFileInfo{
			name:             "000001_create_event_schema.down.sql",
			modTime:          time.Date(2020, 7, 28, 5, 37, 2, 105000000, time.UTC),
		...
		"/node/000001_create_event_schema.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 28, 5, 37, 7, 708000000, time.UTC),
