...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2021, 8, 2, 20, 4, 39, 30572607, time.UTC),
		},
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2021, 9, 30, 8, 40, 54, 25134367, time.UTC),
		},
		...
		"/jobsdb/000005_alter_dataset_table.down.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 9, 30, 8, 41, 16, 250177227, time.UTC),
		...
		"/jobsdb/000005_alter_dataset_table.up.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 9, 30, 8, 49, 43, 594527456, time.UTC),
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 9, 12, 17, 19, 8, 399115022, time.UTC),
		},
		...
		"/node/000005_alter_event_schemas_autovacuum.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 12, 17, 19, 8, 398801893, time.UTC),
		...
		"/node/000006_add_archived_to_event_schemas_tables.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 12, 17, 19, 8, 399032440, time.UTC),
		...
		"/node/000006_remove_archived_from_event_schemas_tables.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 12, 17, 19, 8, 399227599, time.UTC),
		...
		"/reports": &vfsgen۰DirInfo{
			name:    "reports",
			modTime: time.Date(2021, 8, 2, 20, 4, 39, 30479446, time.UTC),
		},
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2021, 9, 12, 17, 19, 8, 399385412, time.UTC),
		},
