...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2021, 9, 1, 9, 19, 44, 96528719, time.UTC),
		},
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 9, 6, 8, 24, 0, 327249159, time.UTC),
		},
		...
		"/node/000005_alter_event_schemas_autovacuum.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 6, 8, 24, 0, 326504984, time.UTC),
		...
		"/node/000006_add_archived_to_event_schemas_tables.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 6, 8, 24, 0, 326929225, time.UTC),
		...
		"/node/000006_remove_archived_from_event_schemas_tables.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 6, 8, 24, 0, 327389216, time.UTC),
		...
		"/reports": &vfsgen۰DirInfo{
			name:    "reports",
			modTime: time.Date(2021, 9, 7, 4, 37, 14, 111752945, time.UTC),
		},
		...
		"/reports/000002_alter_reports.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 7, 4, 39, 50, 167517525, time.UTC),
		...
		"/reports/000002_alter_reports.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 7, 4, 40, 7, 869869472, time.UTC),
			uncompressedSize: 259,

			compressedContent: []byte(""),
		},
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2021, 9, 1, 9, 19, 44, 97470926, time.UTC),
		},
		...
		"/warehouse/000006_add_wh_table_uploads_unique_constraint.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 1, 9, 19, 44, 97148437, time.UTC),
