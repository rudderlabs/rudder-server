...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2021, 9, 6, 10, 14, 13, 0, time.UTC),
		},
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2021, 9, 6, 10, 5, 46, 0, time.UTC),
		},
		"/jobsdb/000001_create_tables.down.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "000001_create_tables.down.tmpl",
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 713352583, time.UTC),
		...
		"/jobsdb/000001_create_tables.up.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 713495726, time.UTC),
		...
		"/jobsdb/000002_alter_dataset_tables.down.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 8, 4, 8, 1, 10, 374161505, time.UTC),
		...
		"/jobsdb/000002_alter_dataset_tables.up.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 713753648, time.UTC),
		...
		"/jobsdb/000003_alter_journal_table.down.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 12, 25, 3, 44, 57, 713868555, time.UTC),
		...
		"/jobsdb/000003_alter_journal_table.up.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 12, 25, 3, 44, 57, 713987451, time.UTC),
		...
		"/jobsdb/000004_alter_status_table.down.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 8, 23, 9, 0, 3, 95795483, time.UTC),
		...
		"/jobsdb/000004_alter_status_table.up.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 8, 23, 9, 0, 3, 96218027, time.UTC),
		...
		"/jobsdb/000005_test.down.tmpl": &vfsgen۰FileInfo{
			name:    "000005_test.down.tmpl",
			modTime: time.Date(2021, 9, 6, 9, 22, 20, 882000000, time.UTC),
			content: []byte(""),
		},
		"/jobsdb/000005_test.up.tmpl": &vfsgen۰FileInfo{
			name:    "000005_test.up.tmpl",
			modTime: time.Date(2021, 9, 6, 9, 22, 12, 977167562, time.UTC),
			content: []byte(""),
		},
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 9, 6, 10, 14, 13, 0, time.UTC),
		...
		"/node/000001_create_event_schema.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 714162314, time.UTC),
		...
		"/node/000001_create_event_schema.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 714284802, time.UTC),
		...
		"/node/000002_create_col_counters_event_schema.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 714405441, time.UTC),
		...
		"/node/000002_del_col_counters_event_schema.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 714521354, time.UTC),
		...
		"/node/000003_add_event_model_columns.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 714646297, time.UTC),
		...
		"/node/000003_remove_event_model_columns.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 714772213, time.UTC),
		...
		"/node/000004_create_ops.down.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 5, 28, 6, 13, 45, 903862381, time.UTC),
		...
		"/node/000004_create_ops.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 5, 28, 6, 13, 45, 904087679, time.UTC),
		...
		"/node/000006_test.down.sql": &vfsgen۰FileInfo{
			name:    "000006_test.down.sql",
			modTime: time.Date(2021, 9, 6, 10, 52, 46, 590396188, time.UTC),
			content: []byte("\x2d\x2d\x2d\x0a\x2d\x2d\x2d\x20\x4f\x70\x65\x72\x61\x74\x69\x6f\x6e\x73\x0a\x2d\x2d\x2d\x0a\x0a\x44\x52\x4f\x50\x20\x54\x41\x42\x4c\x45\x20\x49\x46\x20\x45\x58\x49\x53\x54\x53\x20\x6f\x70\x65\x72\x61\x74\x69\x6f\x6e\x73\x3b"),
		},
		"/node/000006_test.up.sql": &vfsgen۰FileInfo{
			name:    "000006_test.up.sql",
			modTime: time.Date(2021, 9, 6, 10, 53, 42, 472456249, time.UTC),
			content: []byte(""),
		},
		"/node/00005_alter_event_schemas_autovacuum.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 6, 8, 58, 13, 43773542, time.UTC),
		...
		"/reports": &vfsgen۰DirInfo{
			name:    "reports",
			modTime: time.Date(2021, 9, 6, 10, 54, 25, 979802891, time.UTC),
		},
		"/reports/000001_create_reports.down.sql": &vfsgen۰FileInfo{
			name:    "000001_create_reports.down.sql",
			modTime: time.Date(2021, 5, 8, 1, 55, 0, 723168179, time.UTC),
		...
		"/reports/000001_create_reports.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 5, 8, 1, 55, 0, 723475089, time.UTC),
		...
		"/reports/000002_test.down.sql": &vfsgen۰FileInfo{
			name:    "000002_test.down.sql",
			modTime: time.Date(2021, 9, 6, 10, 54, 36, 208905761, time.UTC),
			content: []byte("\x44\x52\x4f\x50\x20\x54\x41\x42\x4c\x45\x20\x49\x46\x20\x45\x58\x49\x53\x54\x53\x20\x72\x65\x70\x6f\x72\x74\x73\x3b"),
		},
		"/reports/000002_test.up.sql": &vfsgen۰FileInfo{
			name:    "000002_test.up.sql",
			modTime: time.Date(2021, 9, 6, 10, 54, 10, 389602180, time.UTC),
			content: []byte(""),
		},
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2021, 9, 6, 10, 55, 18, 460192893, time.UTC),
		},
		"/warehouse/000001_create_tables.up.sql": &vfsgen۰CompressedFileInfo{
			name:             "000001_create_tables.up.sql",
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 714953029, time.UTC),
		...
		"/warehouse/000002_alter_wh_table_uploads.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 25, 3, 44, 57, 715073357, time.UTC),
		...
		"/warehouse/000003_wh_uploads_add_metadata_column.up.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 1, 18, 7, 41, 10, 6375418, time.UTC),
		...
		"/warehouse/000004_add_upd_col_to_wh_schemas_and_uniq_constraint.sql.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 1, 11, 14, 27, 20, 917928938, time.UTC),
		...
		"/warehouse/000005_create_table_schema_versions.sql.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 1, 11, 14, 27, 20, 918541952, time.UTC),
		...
		"/warehouse/000006_add_wh_table_uploads_unique_constraint.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 9, 6, 8, 58, 13, 0, time.UTC),
		...
		"/warehouse/000007_add_wh_uploads_indexes.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 3, 19, 13, 11, 4, 0, time.UTC),
		...
		"/warehouse/000008_add_wh_tables_indices.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 2, 16, 10, 40, 0, 405604895, time.UTC),
		...
		"/warehouse/000009_add_wh_load_file_index_on_table_staging_file.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 4, 29, 4, 11, 47, 675694607, time.UTC),
		...
		"/warehouse/000010_add_metadata_to_wh_staging_files.up.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 5, 8, 1, 55, 0, 724184910, time.UTC),
		...
		"/warehouse/000011_add_wh_loadfiles_metadata_column.up.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 8, 24, 6, 5, 52, 659562105, time.UTC),
		...
		"/warehouse/000012_add_mergedSchema_to_wh_uploads.up.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 8, 24, 6, 5, 52, 659716190, time.UTC),
		...
		"/warehouse/000013_test.up.sql": &vfsgen۰FileInfo{
			name:    "000013_test.up.sql",
			modTime: time.Date(2021, 9, 6, 10, 55, 33, 769328524, time.UTC),
			content: []byte(""),
		},
	}
	...
	fs["/jobsdb"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/jobsdb/000005_test.down.tmpl"].(os.FileInfo),
		fs["/jobsdb/000005_test.up.tmpl"].(os.FileInfo),
	}
	fs["/node"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/node/000006_test.down.sql"].(os.FileInfo),
		fs["/node/000006_test.up.sql"].(os.FileInfo),
	...
	fs["/reports"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/reports/000002_test.down.sql"].(os.FileInfo),
		fs["/reports/000002_test.up.sql"].(os.FileInfo),
	}
	fs["/warehouse"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/warehouse/000013_test.up.sql"].(os.FileInfo),
	}
