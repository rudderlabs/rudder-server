...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2020, 9, 1, 11, 20, 21, 605602631, time.UTC),
		},
		...
		"/node/000003_add_event_model_columns.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 9, 1, 13, 41, 50, 758151028, time.UTC),
		...
		"/node/000003_remove_event_model_columns.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 9, 1, 11, 33, 35, 68613410, time.UTC),
		...
		"/warehouse/000002_alter_wh_table_uploads.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 23, 12, 55, 49, 36000000, time.UTC),
			uncompressedSize: 187,

			compressedContent: []byte(""),
		},
	}
