...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2021, 1, 14, 21, 46, 3, 786965124, time.UTC),
		},
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2021, 6, 21, 10, 3, 36, 537531546, time.UTC),
		},
		...
		"/node/000004_create_ops.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 6, 21, 10, 3, 36, 537585264, time.UTC),
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2021, 8, 11, 11, 25, 45, 733156499, time.UTC),
		},
		...
		"/warehouse/000002_alter_wh_table_uploads.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 1, 14, 21, 46, 3, 788606298, time.UTC),
		...
		"/warehouse/000006_add_wh_table_uploads_unique_constraint.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 2, 9, 15, 39, 35, 96950985, time.UTC),
		...
		"/warehouse/000011_add_wh_loadfiles_metadata_column.up.sql": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 8, 11, 0, 25, 15, 539000000, time.UTC),
		...
		"/warehouse/000012_add_timeWindow_to_wh_staging_files.up.sql": &vfsgen۰FileInfo{
			name:    "000012_add_timeWindow_to_wh_staging_files.up.sql",
			modTime: time.Date(2021, 8, 11, 0, 25, 27, 641000000, time.UTC),
			content: []byte(""),
		},
		"/warehouse/000013_add_mergedSchema_to_wh_uploads.up.sql": &vfsgen۰FileInfo{
			name:    "000013_add_mergedSchema_to_wh_uploads.up.sql",
			modTime: time.Date(2021, 8, 11, 11, 26, 5, 156667246, time.UTC),
	...
	fs["/warehouse"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/warehouse/000012_add_timeWindow_to_wh_staging_files.up.sql"].(os.FileInfo),
		fs["/warehouse/000013_add_mergedSchema_to_wh_uploads.up.sql"].(os.FileInfo),
	}
