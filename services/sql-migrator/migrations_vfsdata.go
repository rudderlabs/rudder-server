...
var MigrationAssets = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/jobsdb": &vfsgen۰DirInfo{
			name:    "jobsdb",
			modTime: time.Date(2020, 12, 25, 10, 58, 13, 624607060, time.UTC),
		},
		...
		"/jobsdb/000003_alter_journal_table.down.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 12, 25, 10, 58, 13, 624542920, time.UTC),
		...
		"/jobsdb/000003_alter_journal_table.up.tmpl": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 12, 25, 10, 58, 13, 624699102, time.UTC),
		...
		"/node": &vfsgen۰DirInfo{
			name:    "node",
			modTime: time.Date(2020, 11, 5, 19, 1, 8, 196176363, time.UTC),
		},
		...
		"/node/000001_create_event_schema.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 9, 1, 2, 9, 34, 577067718, time.UTC),
		...
		"/node/000002_create_col_counters_event_schema.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 8, 27, 3, 33, 55, 210771711, time.UTC),
		...
		"/node/000002_del_col_counters_event_schema.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 8, 27, 3, 33, 55, 210914717, time.UTC),
		...
		"/node/000003_add_event_model_columns.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 5, 19, 1, 8, 196003275, time.UTC),
		...
		"/node/000003_remove_event_model_columns.down.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 5, 19, 1, 8, 196611120, time.UTC),
		...
		"/warehouse": &vfsgen۰DirInfo{
			name:    "warehouse",
			modTime: time.Date(2020, 12, 25, 10, 58, 13, 624827240, time.UTC),
		},
		...
		"/warehouse/000002_alter_wh_table_uploads.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 12, 16, 5, 25, 59, 312481954, time.UTC),
		...
		"/warehouse/000003_wh_table_uploads_metadata_column.up.sql": &vfsgen۰FileInfo{
			name:    "000003_wh_table_uploads_metadata_column.up.sql",
			modTime: time.Date(2020, 12, 28, 9, 40, 27, 775887523, time.UTC),
			content: []byte(""),
		},
	}
	...
	fs["/warehouse"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/warehouse/000003_wh_table_uploads_metadata_column.up.sql"].(os.FileInfo),
	}
