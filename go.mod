...
require (
	...
	github.com/rudderlabs/keydb v1.3.5
	github.com/rudderlabs/rudder-go-kit v0.72.3
	github.com/rudderlabs/rudder-observability-kit v0.0.6
	github.com/rudderlabs/rudder-schemas v0.9.3
	github.com/rudderlabs/rudder-transformer/go v1.124.3
	github.com/rudderlabs/sql-tunnels v0.1.7
	github.com/rudderlabs/sqlconnect-go v1.24.1
