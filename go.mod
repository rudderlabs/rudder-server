...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/personalizeevents v1.37.0
	...
	github.com/rudderlabs/rudder-transformer/go v1.152.0
	github.com/rudderlabs/sql-tunnels v0.1.8
	github.com/rudderlabs/sqlconnect-go v1.30.3
