...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/personalizeevents v1.32.0
	...
	github.com/rudderlabs/rudder-transformer/go v1.137.0
	github.com/rudderlabs/sql-tunnels v0.1.7
	github.com/rudderlabs/sqlconnect-go v1.26.0
