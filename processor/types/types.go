...
type CompactedTransformRequest struct {
	...
	Destinations map[string]backendconfig.DestinationT `json:"destinations,omitempty"`
	Connections  map[string]backendconfig.Connection   `json:"connections,omitempty"`
}

// ToUserTransformerEvent removes the connection and credentials from the event
...
func (e *TransformerEvent) ToUserTransformerEvent() *UserTransformerEvent {
	ute := &UserTransformerEvent{
		...
		Credentials: e.Credentials, // TODO: do we need this or not?
	}
