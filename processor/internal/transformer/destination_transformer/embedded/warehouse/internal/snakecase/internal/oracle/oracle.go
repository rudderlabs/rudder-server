// Package oracle is a FROZEN, verbatim copy of the snakecase implementation as
// it existed when it was backed entirely by github.com/dlclark/regexp2.
//
// It exists solely as a reference oracle for the differential test harness in
// the snakecase package: any replacement of the production implementation must
// produce byte-for-byte identical output to this package for every input.
//
// DO NOT "improve", refactor, or optimize this file. Its only job is to encode
// the exact historical behavior so we can prove a faster implementation matches
// it. If you change production behavior intentionally, update this copy in the
// same change and explain why in the commit.
package oracle
