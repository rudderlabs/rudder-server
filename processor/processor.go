...
func (proc *Handle) loadReloadableConfig(defaultPayloadLimit int64, defaultMaxEventsToProcess int) {
	...
	proc.config.transformBatchSize = config.GetReloadableIntVar(10, 1, "Processor.transformBatchSizeTODO")
	proc.config.userTransformBatchSize = config.GetReloadableIntVar(10, 1, "Processor.userTransformBatchSizeTODO")
