...
func (proc *LifecycleManager) Start() error {
	...
	proc.Handle.Setup(
		proc.BackendConfig, proc.gatewayDB, proc.routerDB, proc.batchRouterDB, proc.errDB, proc.eventSchemasDB,
...
func New(ctx context.Context, clearDb *bool, gwDb, rtDb, brtDb, errDb, eventSchemasDB *jobsdb.HandleT,
