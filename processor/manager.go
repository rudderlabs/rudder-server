...
func (proc *LifecycleManager) Start() error {
	...
	proc.Handle.Setup(
		proc.BackendConfig, proc.gatewayDB, proc.routerDB, proc.batchRouterDB, proc.errDB, proc.esDB, proc.archDB,
...
func New(ctx context.Context, clearDb *bool, gwDb, rtDb, brtDb, errDb, esDB, archDB *jobsdb.HandleT,
