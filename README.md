...
2. Processing Flexibility: You should be able to enhance OR transform your event data by combining it with your other *internal* data, e.g. stored in your transactional systems. Running *inside* your cloud or on-prem environment makes that possible.
