...
func (b *Batch) listFiles(ctx context.Context) ([]*filemanager.FileObject, error) {
	...
	fileObjects, err := b.FM.ListFilesWithPrefix(context.Background(), "", listMaxItem)
	if err != nil {
...
func (b *Batch) download(ctx context.Context, completeFileName string) (string, error) {
	...
	err = b.FM.Download(context.Background(), tmpFilePtr, completeFileName)
	if err != nil {
...
func (b *Batch) upload(ctx context.Context, uploadFileAbsPath, actualFileName, absStatusTrackerFileName string) error {
	...
	_, err = b.FM.Upload(context.Background(), uploadFilePtr, fileNamePrefixes[1:len(fileNamePrefixes)-1]...)
	if err != nil {
	...
	_, err = b.FM.Upload(context.Background(), statusTrackerFilePtr)
	if err != nil {
...
func (b *Batch) cleanup(prefix string) {
	...
	err := b.FM.DeleteObjects(context.Background(), []string{filepath.Join(prefix, StatusTrackerFileName)})
	if err != nil {
