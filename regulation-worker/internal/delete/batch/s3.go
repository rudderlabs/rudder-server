...
func (*S3DeleteManager) delete(ctx context.Context, patternFile, decompressedFile string) ([]byte, error) {
	...
	pkgLogger.Debugf("deletion successful from file: %v", decompressedFile)
	return out, nil
}
