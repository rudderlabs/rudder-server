...
func (mockFileManagerFactory) New(settings *filemanager.SettingsT) (filemanager.FileManager, error) {
...
func (*mockFileManager) GetDownloadKeyFromFileLocation(location string) string {
	return ""
}
