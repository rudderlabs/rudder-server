...
func NewBingAdsBulkUploader(baseManager *bingadscommon.BaseManager) *BingAdsBulkUploader {
	return &BingAdsBulkUploader{
		...
		logger:        baseManager.Logger.Child(baseManager.DestinationName).Child("BingAdsBulkUploader"),
		...
		eventsLimit:   common.GetBatchRouterConfigInt64("MaxEventsLimit", baseManager.DestinationName, 4000000),
	}
}
...
func NewManager(
	...
	return NewBingAdsBulkUploader(baseManager), nil
}
...
func (b *BingAdsBulkUploader) getUploadStatsOfSingleImport(filePath string) (common.GetUploadStatsResponse, error) {
	...
	eventStatsResponse := common.GetUploadStatsResponse{
		...
		Metadata: common.EventStatMeta{
			...
			AbortedReasons: bingadscommon.GetAbortedReasons(clientIDErrors),
		},
	}
