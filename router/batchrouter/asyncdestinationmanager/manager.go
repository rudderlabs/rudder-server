...
import (
	...
	"github.com/rudderlabs/rudder-server/router/batchrouter/asyncdestinationmanager/bqstreaming"
...
func newRegularManager(
	...
	case "BQ_STREAMING":
		return common.SimpleAsyncDestinationManager{UploaderAndTransformer: bqstreaming.NewManager(conf, logger, statsFactory, destination)}, nil
	}
