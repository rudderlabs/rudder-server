...
func (brt *Handle) Setup(
	...
	// TODO: Revert
	config.RegisterDurationConfigVariable(2, &brt.asyncUploadTimeout, true, time.Minute, []string{"BatchRouter." + brt.destType + "." + "asyncUploadTimeout", "BatchRouter." + "asyncUploadTimeout"}...)
