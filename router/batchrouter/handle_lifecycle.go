...
func (brt *Handle) Setup(
	...
	config.RegisterDurationConfigVariable(30, &brt.asyncUploadTimeout, true, time.Second, []string{"BatchRouter." + brt.destType + "." + "asyncUploadTimeout", "BatchRouter." + "asyncUploadTimeout"}...)
