...
func (rt *HandleT) readAndProcess() int {
	...
	pickupMap, latenciesUsed := multitenant.GetRouterPickupJobs(rt.destName, rt.recentJobInResultSet, rt.routerLatencyStat, rt.noOfWorkers, timeOut, rt.routerLatencyStat, jobQueryBatchSize, rt.timeGained)
