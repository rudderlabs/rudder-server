...
type Handle struct {
	...
	// saveDestinationResponse mirrors the destination definition's response-retention flag.
	// Same access pattern as supportsDeliveredWithWarnings below, hence atomic.
