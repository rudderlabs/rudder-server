...
func (rt *Handle) setupReloadableVars() {
	...
	rt.reloadableConfig.sourcesRetryTimeWindow = config.GetReloadableDurationVar(1, time.Minute, "Router.RSources"+rt.destType+".retryTimeWindow", "Router.RSources"+rt.destType+".retryTimeWindowInMins", "Router.RSources.retryTimeWindow", "Router.RSources.retryTimeWindowInMins")
