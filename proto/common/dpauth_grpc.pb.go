...
const (
	...
	DPAuthService_NotifyDuplicateConnection_FullMethodName = "/proto.DPAuthService/NotifyDuplicateConnection"
)
...
type DPAuthServiceClient interface {
	...
	NotifyDuplicateConnection(ctx context.Context, in *DuplicateConnectionRequest, opts ...grpc.CallOption) (*DuplicateConnectionResponse, error)
}
...
func (c *dPAuthServiceClient) NotifyDuplicateConnection(ctx context.Context, in *DuplicateConnectionRequest, opts ...grpc.CallOption) (*DuplicateConnectionResponse, error) {
	out := new(DuplicateConnectionResponse)
	err := c.cc.Invoke(ctx, DPAuthService_NotifyDuplicateConnection_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DPAuthServiceServer interface {
	...
	NotifyDuplicateConnection(context.Context, *DuplicateConnectionRequest) (*DuplicateConnectionResponse, error)
...
func (UnimplementedDPAuthServiceServer) NotifyDuplicateConnection(context.Context, *DuplicateConnectionRequest) (*DuplicateConnectionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NotifyDuplicateConnection not implemented")
}
...
func _DPAuthService_NotifyDuplicateConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DuplicateConnectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DPAuthServiceServer).NotifyDuplicateConnection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DPAuthService_NotifyDuplicateConnection_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DPAuthServiceServer).NotifyDuplicateConnection(ctx, req.(*DuplicateConnectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DPAuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NotifyDuplicateConnection",
			Handler:    _DPAuthService_NotifyDuplicateConnection_Handler,
		},
	},
