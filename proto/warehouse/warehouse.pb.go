...
func (x *ValidationRequest) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *ValidationRequest) GetStep() string {
	if x != nil {
		return x.Step
	}
	return ""
...
func (x *ValidationRequest) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *ValidationResponse) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_proto_warehouse_warehouse_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x63,
	...
	0x6f, 0x64, 0x79, 0x22, 0x3e, 0x0a, 0x12, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f,
	...
	0x61, 0x74, 0x61, 0x32, 0xaa, 0x03, 0x0a, 0x09, 0x57, 0x61, 0x72, 0x65, 0x68, 0x6f, 0x75, 0x73,
	...
	0x3f, 0x0a, 0x08, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x12, 0x18, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x61,
...
var file_proto_warehouse_warehouse_proto_goTypes = []interface{}{
	...
	(*ValidationRequest)(nil),        // 7: proto.ValidationRequest
...
var file_proto_warehouse_warehouse_proto_depIdxs = []int32{
	...
	7,  // 14: proto.Warehouse.Validate:input_type -> proto.ValidationRequest
	...
	8,  // 20: proto.Warehouse.Validate:output_type -> proto.ValidationResponse
