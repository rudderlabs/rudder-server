...
type CountWHUploadsToRetryResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CountWHUploadsToRetryResponse) Reset() {
	*x = CountWHUploadsToRetryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CountWHUploadsToRetryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CountWHUploadsToRetryResponse) ProtoMessage() {}

func (x *CountWHUploadsToRetryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_warehouse_warehouse_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CountWHUploadsToRetryResponse.ProtoReflect.Descriptor instead.
func (*CountWHUploadsToRetryResponse) Descriptor() ([]byte, []int) {
	return file_proto_warehouse_warehouse_proto_rawDescGZIP(), []int{11}
}

func (x *CountWHUploadsToRetryResponse) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *CountWHUploadsToRetryResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *CountWHUploadsToRetryResponse) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
var file_proto_warehouse_warehouse_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x70, 0x0a, 0x1d,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x57, 0x48, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x54, 0x6f,
	0x52, 0x65, 0x74, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a,
	...
	0x28, 0x05, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x32, 0xda,
	0x04, 0x0a, 0x09, 0x57, 0x61, 0x72, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x09,
	...
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5b,
	...
	0x74, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2e,
...
var file_proto_warehouse_warehouse_proto_goTypes = []interface{}{
	...
	(*CountWHUploadsToRetryResponse)(nil), // 11: proto.CountWHUploadsToRetryResponse
...
var file_proto_warehouse_warehouse_proto_depIdxs = []int32{
	12, // 0: proto.WHTable.last_exec_at:type_name -> google.protobuf.Timestamp
	...
	12, // 3: proto.WHUploadResponse.created_at:type_name -> google.protobuf.Timestamp
	12, // 4: proto.WHUploadResponse.first_event_at:type_name -> google.protobuf.Timestamp
	12, // 5: proto.WHUploadResponse.last_event_at:type_name -> google.protobuf.Timestamp
	12, // 6: proto.WHUploadResponse.last_exec_at:type_name -> google.protobuf.Timestamp
	12, // 7: proto.WHUploadResponse.next_retry_time:type_name -> google.protobuf.Timestamp
	1,  // 8: proto.WHUploadResponse.tables:type_name -> proto.WHTable
	13, // 9: proto.Warehouse.GetHealth:input_type -> google.protobuf.Empty
	...
	14, // 17: proto.Warehouse.GetHealth:output_type -> google.protobuf.BoolValue
	...
	11, // 24: proto.Warehouse.CountWHUploadsToRetry:output_type -> proto.CountWHUploadsToRetryResponse
...
func file_proto_warehouse_warehouse_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_warehouse_warehouse_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CountWHUploadsToRetryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
