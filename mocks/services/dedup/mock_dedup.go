...
func (m *MockDedup) FindDuplicates(arg0 []dedup.Info, arg1 map[string]dedup.Payload) map[int]dedup.Payload {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindDuplicates", arg0, arg1)
	ret0, _ := ret[0].(map[int]dedup.Payload)
	return ret0
}

// FindDuplicates indicates an expected call of FindDuplicates.
func (mr *MockDedupMockRecorder) FindDuplicates(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindDuplicates", reflect.TypeOf((*MockDedup)(nil).FindDuplicates), arg0, arg1)
}

// MarkProcessed mocks base method.
func (m *MockDedup) MarkProcessed(arg0 []dedup.Info) error {
	m.ctrl.T.Helper()
