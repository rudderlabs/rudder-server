...
// Source: github.com/rudderlabs/rudder-server/router/batchrouter/asyncdestinationmanager/klaviyobulkupload (interfaces: Uploader,HttpClient,Poller,ProfileExtractor,UploadStats)
//
// Generated by this command:
//
//	mockgen -destination=../../../../mocks/router/klaviyobulkupload/klaviyobulkupload_mock.go -package=mocks github.com/rudderlabs/rudder-server/router/batchrouter/asyncdestinationmanager/klaviyobulkupload Uploader,HttpClient,Poller,ProfileExtractor,UploadStats
//
...
type MockProfileExtractorMockRecorder struct {
	mock *MockProfileExtractor
}

// NewMockProfileExtractor creates a new mock instance.
func NewMockProfileExtractor(ctrl *gomock.Controller) *MockProfileExtractor {
	mock := &MockProfileExtractor{ctrl: ctrl}
	mock.recorder = &MockProfileExtractorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProfileExtractor) EXPECT() *MockProfileExtractorMockRecorder {
	return m.recorder
}
...
func (mr *MockUploadStatsMockRecorder) GetUploadStats(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
