...
//
//	mockgen -destination=mocks/router/salesforce-bulk-upload/backend_config_mock.go -package=salesforcebulkupload_mocks github.com/rudderlabs/rudder-server/backend-config BackendConfig
//
