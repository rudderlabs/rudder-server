...
func (m *MockJobsDB) GetDistinctParameterValues(ctx context.Context, parameter jobsdb.ParameterName, customValFilter string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDistinctParameterValues", ctx, parameter, customValFilter)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockJobsDBMockRecorder) GetDistinctParameterValues(ctx, parameter, customValFilter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDistinctParameterValues", reflect.TypeOf((*MockJobsDB)(nil).GetDistinctParameterValues), ctx, parameter, customValFilter)
}
...
func (m *MockJobsDB) GetPileUpCounts(ctx context.Context, increaseFunc rmetrics.IncreasePendingEventsFunc) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPileUpCounts", ctx, increaseFunc)
	ret0, _ := ret[0].(error)
	return ret0
}

// GetPileUpCounts indicates an expected call of GetPileUpCounts.
func (mr *MockJobsDBMockRecorder) GetPileUpCounts(ctx, increaseFunc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPileUpCounts", reflect.TypeOf((*MockJobsDB)(nil).GetPileUpCounts), ctx, increaseFunc)
}
...
func (m *MockJobsDB) StoreInTx(ctx context.Context, arg1 jobsdb.StoreSafeTx, jobList []*jobsdb.JobT) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StoreInTx", ctx, arg1, jobList)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockJobsDBMockRecorder) StoreInTx(ctx, arg1, jobList any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StoreInTx", reflect.TypeOf((*MockJobsDB)(nil).StoreInTx), ctx, arg1, jobList)
}
