...
func (m *MockJobsDB) GetExecuting(arg0 jobsdb.GetQueryParamsT) jobsdb.JobsT {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExecuting", arg0)
	ret0, _ := ret[0].(jobsdb.JobsT)
	return ret0
}
...
func (m *MockJobsDB) GetImporting(arg0 jobsdb.GetQueryParamsT) jobsdb.JobsT {
	m.ctrl.T.Helper()
...
func (m *MockJobsDB) GetProcessed(arg0 jobsdb.GetQueryParamsT) jobsdb.JobsT {
	m.ctrl.T.Helper()
...
func (m *MockJobsDB) GetToRetry(arg0 jobsdb.GetQueryParamsT) jobsdb.JobsT {
	m.ctrl.T.Helper()
...
func (m *MockJobsDB) GetUnprocessed(arg0 jobsdb.GetQueryParamsT) jobsdb.JobsT {
	m.ctrl.T.Helper()
...
func (m *MockJobsDB) GetWaiting(arg0 jobsdb.GetQueryParamsT) jobsdb.JobsT {
	m.ctrl.T.Helper()
