...
func (m *MockUploadJob) setUploadColumns(opts warehouse.UploadColumnsOpts) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "setUploadColumns", opts)
	ret0, _ := ret[0].(error)
	return ret0
}

// setUploadColumns indicates an expected call of setUploadColumns.
func (mr *MockUploadJobMockRecorder) setUploadColumns(opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "setUploadColumns", reflect.TypeOf((*MockUploadJob)(nil).setUploadColumns), opts)
}
