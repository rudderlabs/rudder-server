...
func (m *MockProcessor) stagingFiles(w warehouseutils.Warehouse, startID, endID int64) ([]*warehouse.StagingFileT, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "stagingFiles", w, startID, endID)
...
func (mr *MockProcessorMockRecorder) stagingFiles(w, startID, endID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "stagingFiles", reflect.TypeOf((*MockProcessor)(nil).stagingFiles), w, startID, endID)
}

// uploadToProcess mocks base method.
func (m *MockProcessor) uploadToProcess(availableWorkers int, skipIdentifiers []string) ([]warehouse.UploadJob, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "uploadToProcess", availableWorkers, skipIdentifiers)
	ret0, _ := ret[0].([]warehouse.UploadJob)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
